...
class ApiUrls {
  ...
  static String get _customerBaseUrl =>
      "$_baseUrl$_customer$_path$_v1$_customer";
  ...
  static final String language =
      "$_fetchUrl$_customer$_path$_v1/metadata/languages";
  ...
  static final String createDocument =
      "$_fetchUrl$_document$_path$_v1/documents";
  static final String deleteDocument =
      "$_fetchUrl$_document$_path$_v1/documents/";
  static final String saveDeviceToken =
      "$_fetchUrl$_customer$_path$_v1$_customer/device-token";
  static final String getDeviceToken =
      "$_fetchUrl$_customer$_path$_v1$_customer/device-token";
  static final String getDocumentType =
      "$_fetchUrl$_document$_path$_v1/document-type";
  static final String checkAppUpdate =
      "$_fetchUrl$_customer$_path$_v1/app-update-config/check";
  static final String deleteCustomer =
      "$_fetchUrl$_customer$_path$_v1$_customer";
  static final String updateCompanyInfo =
      "$_fetchUrl$_customer$_path$_v1/customer/update-company-info";

  /// Onboarding
  static final String sendEmailOtp =
      "$_baseUrl$_customer$_path$_v1$_customer/create-customer/email-otp/send";
  static final String emailOTPCodeVerification =
      "$_baseUrl$_customer$_path$_v1$_customer/create-customer/email-otp/verify";
  static final String termsAndConditions =
      "$_fetchUrl$_customer$_path$_v1/metadata/terms-and-conditions";
  static final String privacyPolicy =
      "$_fetchUrl$_customer$_path$_v1/metadata/privacy-policies";
  static final String refreshToken =
      "$_fetchUrl$_customer$_path$_v1$_auth/refresh-token";

  /// VP Endpoints
  static final String createVpAccount = "$_customerBaseUrl$_vp/";
  static final String vpLoadList =
      "$_baseUrl$_load$_path$_v1$_load$_vp/my-load";
  ...
  static final String vpRecentLoads =
      "$_baseUrl$_load$_path$_v1$_load$_vp/recent-load";
  static final String vpAcceptLoad =
      "$_baseUrl$_loadExecution$_path$_v1$_load/";
  static final String scheduleTrip =
      "$_baseUrl$_load$_path$_v1/loads/schedule-trip";
  ...
  static final String getAllVpLoads =
      "$_baseUrl$_loadDiscovery$_path$_v1$_load";
  static final String updateLoadStatus =
      "$_baseUrl$_loadExecution$_path$_v1$_load/updateStatus";
  static final String loadDocument =
      "$_fetchUrl$_load$_path$_v1/loads/load-document";
  static final String viewDocument =
      "$_fetchUrl$_document$_path$_v1/documents/";
  static final String deleteLoadDocument =
      "$_fetchUrl$_load$_path$_v1/loads/load-document/";
  ...
  static final String bluIdFlg =
      "$_baseUrl$_customer$_path$_v1$_customer/blue-id-flg/update/";
  ...
  static final String companyType =
      "$_baseUrl$_customer$_path$_v1/company-type";
  ...
  static final String lpLoadList =
      "$_baseUrl$_loadDiscovery$_path$_v1$_load/list/v2";
  ...
  static final String lpLoadSendOtp =
      "$_baseUrl$_loadExecution$_path$_v1$_load/Esignmemo";
  static final String lpLoadVerifyOtp =
      "$_baseUrl$_loadExecution$_path$_v1$_load/verify-esign-otp";
  static final String lpLoadRoute = "$_baseUrl$_rateDiscovery$_path$_v1/lane";
  static final String lpCreditCheck =
      "$_baseUrl$_credit$_path$_v1/credit-limit/export";
  static final String getMyLoad =
      "$_baseUrl$_credit$_path$_v1/credit-limit/export";
  static final String lpLoadAgree =
      "$_baseUrl$_loadExecution$_path$_v1$_load/lp-agree";
  static final String lpLoadVerifyAdvance =
      "$_baseUrl$_loadExecution$_path$_v1$_load/verify-advance";
  static final String lpLoadFeedback =
      "$_baseUrl$_loadExecution$_path$_v1$_load/";
  static final String lpLoadDocument =
      "$_baseUrl$_document$_path$_v1/documents/";
  static final String lpLoadAddConsignee =
      "$_baseUrl$_load$_path$_v1/consignee";
  static final String lppayment =
      "$_fetchUrl$_vendor$_path$_v1/payment/addCustomerPaymentOption";
  static final String lpCreateOrderBase = "$_paymentBrokerBase/order/pay";
  static final String podCenter =
      "$_baseUrl$_loadDiscovery$_path$_v1$_load/podCenterList";
  ...
  static final String getRateDiscoveryPrice =
      "$baseUrl$_rateDiscovery$_path$_v1/rate-discovery/fetch-rate";
  static final String getRecentRoute =
      "$baseUrl$_loadDiscovery$_path$_v1$_load/distinct-source-destination";
  static final String getWeight =
      "$_baseUrl$_rateDiscovery$_path$_v1/weightage";
  static final String createLoad = "$_baseUrl$_load$_path$_v1/loads";
  static final String getLoads =
      "$baseUrl$_loadDiscovery$_path$_v1$_load$_customer/";
  ...
  static final String updateDamage =
      "$_baseUrl$_loadSettlement$_path$_v1/damage/";
  static final String deleteDamage =
      "$_baseUrl$_loadSettlement$_path$_v1/damage/";
  static final String submitPod = "$_loadBaseUrl/pod";
  static final String getTripStatement =
      "$_baseUrl$_loadExecution$_path$_v1$_load/trip-statement/";
  ...
  //Kavach
  static String kavachOrdersList =
      "$_baseUrl$_fleet$_path$_v1/orders/customer-orders/list";
  static String get kavachProductList =>
      "$_baseUrl$_fleet$_path$_v1/product/list";
  static String get kavachVehicleDetails =>
      "$_baseUrl$_customer$_path$_v1/vehicle";
  static String get kavachAddressList =>
      "$_baseUrl$_customer$_path$_v1/address";
  static String get kavachAvailableStock =>
      "$_baseUrl$_fleet$_path$_v1/stocks/available-stock";
  static String get kavachCreateOrder =>
      "$_baseUrl$_fleet$_path$_v1/orders/create";
  ...
  static String kavachFetchCommodities =
      "$_baseUrl$_load$_path$_v1/commodities";
  ...
  /// En-Dhan
  static final String endhanSubmitKyc =
      "$_baseUrl$_customer$_path$_v1/kyc/endhan/";
  static final String enDhanKycUpload =
      "$_fetchUrl$_vendor$_path$_v1/dtplus/customerDocument";
  static String enDhanKycCheck(String customerId) =>
      "$_fetchUrl$_vendor$_path$_v1/dtplus/customerDocument/$customerId";

  // En-Dhan Card APIs
  static String enDhanCards(String customerId) =>
      "$_fetchUrl$_vendor$_path$_v1/dtplus/card/$customerId";
  static String enDhanCardBalance(String customerId) =>
      "$_fetchUrl$_vendor$_path$_v1/dtplus/cardBalance/$customerId";

  // En-Dhan Customer Creation and Master Data APIs
  static final String enDhanCreateCustomer =
      "$_fetchUrl$_vendor$_path$_v1/dtplus/createCustomer";
  static final String enDhanStates =
      "$_fetchUrl$_vendor$_path$_v1/dtplus/state";
  static final String enDhanDistricts =
      "$_fetchUrl$_vendor$_path$_v1/dtplus/district/";
  static final String enDhanZonal = "$_fetchUrl$_vendor$_path$_v1/dtplus/zonal";
  static final String enDhanRegional =
      "$_fetchUrl$_vendor$_path$_v1/dtplus/regional/";
  static final String enDhanVehicleTypes =
      "$_fetchUrl$_vendor$_path$_v1/dtplus/vehicleType";
  static final String enDhanTransaction =
      "$_fetchUrl$_vendor$_path$_v1/dtplus/getTransaction";
  static String enDhanGetPincode(String pincode) =>
      "$_fetchUrl$_vendor$_path$_v1/dtplus/getPincode/$pincode";
  static final String enDhanServerStatus =
      "$_fetchUrl$_vendor$_path$_v1/dtplus/endhanServerStatus";

  /// GPS
  static final String gpsDocumentUpload = ApiUrls.enDhanKycUpload;
  static String gpsKycCheck(String customerId) =>
      "$_fetchUrl/customer/api/v1/kyc/$customerId";
  static String gpsKycUpload(String customerId) =>
      "$_fetchUrl/customer/api/v1/kyc/$customerId";
  static final String gpsProductList =
      "$_fetchUrl$_fleet$_path$_v1/product/list";
  static final String gpsAddressList = "$_fetchUrl$_customer$_path$_v1/address";
  static final String gpsCreateOrder =
      "$_baseUrl$_fleet$_path$_v1/orders/create";
  static final String gpsOrderSummary =
      "$_baseUrl$_fleet$_path$_v1/orders/order-summary";
  static final String gpsCustomerOrdersList =
      "$_baseUrl$_fleet$_path$_v1/orders/customer-orders/list";

  ///Fastag
  static final String fastagAddVehicle =
      "$_fetchUrl$_vendor$_path$_v1/fast-tag/addVehicle";
  //https://gro-uat-api.letsgro.co/vendor/api/v1/fast-tag/card/$customerId
  static String fastagOrderList(String customerId) =>
      "$_fetchUrl$_vendor$_path$_v1/fast-tag/card/$customerId";

  ///Gps and kavach payment initate
  static final String fleetPayment =
      "$_fetchUrl$_paymentBroker$_path$_v1/payment/initiate";

  // Document Upload API
  static final String documentUpload = "$_fetchUrl/document/api/v1/upload";

  // User Management API
  static final String getAllUsers =
      "$_fetchUrl/user/api/v1/users/getReferralCode";

  /// Google Map
  static String googleDirectionApi =
      "$_baseUrl/ratediscovery/api/v1/map-location/directions";

  /// Tracking
  static String trackingDistance =
      "$_baseUrl$_loadTracking$_path$_v1$_tracking/calculate-distance";

  /// Driver
  static final String driverLoadListBaseUrl =
      "$_baseUrl$_loadDiscovery$_path$_v1$_load/driver/list?isDriver=true";
  static final String driverProfile =
      "$_baseUrl$_customer$_path$_v1/drivers/id/";
  static final String driverLoadById =
      "$_baseUrl$_loadDiscovery$_path$_v1/load/driver/";
  static final String getBloodGroup =
      "$_fetchUrl$_customer$_path$_v1/blood-group";
  static final String getLicenseCategory =
  ...
  static final String getMembershipBenefit =
      "$_baseUrl$_customer$_path$_v1/metadata/membership-benefit";
  ...
  static final String setPrimaryAddress =
      "$_baseUrl$_customer$_path$_v1/address/is-default/";
  ...
  static final String getCustomerSettings =
      "$_baseUrl$_customer$_path$_v1/settings/";
  static final String updateCustomerSettings =
      "$_baseUrl$_customer$_path$_v1/settings/";
  static final String getVehicleList = "$_baseUrl$_customer$_path$_v1/vehicle/";
  static final String deleteVehicle =
      "$_baseUrl$_customer$_path$_v1/vehicle/status/";
  static final String driverListUrl = "$_baseUrl$_customer$_path$_v1/drivers";
  static final String getTicketList =
      "$_baseUrl$_customer$_path$_v1/support-ticket/";
  static final String getTicketMessages =
      "$_baseUrl$_customer$_path$_v1/support-ticket/";
  ...
  static final String getFaq =
      "$_baseUrl$_customer$_path$_v1/metadata/support-faq";
  static final String checkVehicleNumber =
      "$_fetchUrl$_customer$_path$_v1/vehicle/check/vehicle-no/";
  static final String checkLicenseNumber =
      "$_fetchUrl$_customer$_path$_v1/drivers/check-license/";

  /// DIGI LOCKER

  static final String digiLockerInit =
      "$groServicesUrl/aadhar/api/v1/digilocker/init";
  static final String adharStatus =
      "$groServicesUrl/aadhar/api/v1/aadhar_status/";

  static final String licenseVahanVerfification =
      "$groServicesUrl/driving_license/api/v1/send_license_number";
  static final String vehicleVahanVerfification =
      "$groServicesUrl/vehicle_number/api/v1/send_vehicle_number";
  ...
  /// Events API
  static final String createEvent =
      "https://groone-uat.letsgro.co/audit/api/v1/events";
}
