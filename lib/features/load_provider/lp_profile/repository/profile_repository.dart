...
import 'package:gro_one_app/features/load_provider/lp_profile/model/profile_upload_response.dart';
...
class ProfileRepository {
  ...
  }Future<Result<ProfileImageUploadResponse>> uploadProfile( ProfileImageUploadRequest request,
  {required String userId}
  ) async {
    try {
      return await _profileService.profileUpload(request,userId:userId);
    } catch (e) {
      CustomLog.error(this, "Failed to request Login In", e);
      return Error(ErrorWithMessage(message: e.toString()));
    }
