...
class VpRecentLoadListBloc extends Bloc<VpRecentLoadListEvent, VpRecentLoadListState> {
  ...
  VpRecentLoadListBloc(this._vHomeRepository) : super(VpRecentLoadListInitial()) {
    on<VpRecentLoadEvent>(getRecentLoad);
    on<ResetVpRecentLoadEvent>(resetUIState);
  }

  Future<void> getRecentLoad(VpRecentLoadEvent event, Emitter<VpRecentLoadListState> emit) async {
