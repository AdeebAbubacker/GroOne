...
class VpCustomerModel {
  ...
  factory VpCustomerModel.fromJson(Map<String, dynamic> json) {
    return VpCustomerModel(
      ...
      companyTypeId: _parseInt(json["companyTypeId"]),
      emailId: json["emailId"] ?? "",
      password: json["password"] ?? "",
      companyName: json["companyName"] ?? "",
      otp: _parseInt(json["otp"]),
      otpAttempt: json["otpAttempt"]?.toString(),
      isKyc: _parseInt(json["isKyc"]),
...
class VpvehiclesDetails {
  ...
  factory VpvehiclesDetails.fromJson(Map<String, dynamic> json) {
    return VpvehiclesDetails(
      ...
      customerId: json["customer_id"] ?? "",
      truckType: json["truckType"] == null ? [] : List<int>.from(json["truckType"].map((x) => _parseInt(x))),
      ownedTrucks: _parseInt(json["ownedTrucks"]),
      attachedTrucks: _parseInt(json["attachedTrucks"]),
      preferredLanes: json["preferredLanes"] == null ? [] : List<int>.from(json["preferredLanes"].map((x) => _parseInt(x))),
      status: _parseInt(json["status"]),
      createdAt: DateTime.tryParse(json["created_at"] ?? ""),
      updatedAt: DateTime.tryParse(json["updated_at"] ?? ""),
      deletedAt: json["deleted_at"],
