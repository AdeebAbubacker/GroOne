    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: BlocBuilder<KavachTransactionsCubit, KavachTransactionsState>(
              ...
              builder: (context, state) {
                if (state is KavachTransactionsLoading) {
                  ...
                  final filteredPayments = state.transactions
                      .where((p) =>
                  p.referenceNumber
                      .toLowerCase()
                      ...
                      return Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                KavachHelper.formatCurrency(double.tryParse(txn.paidAmount) ?? 0.0),
