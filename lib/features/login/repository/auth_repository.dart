...
class AuthRepository {
  ...
  /// Save user data
  Future<Result<bool>> saveUserInfoFromLogin(LoginApiResponseModel user) async {
    try {
      ...
      await _securedSharedPref.saveKey(AppString.sessionKey.userRole, userData.user.roleId.toString());
