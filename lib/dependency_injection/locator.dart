...
void initLocator() {
  try {
    ...
    locator.registerLazySingleton(
      () => VpHomeRepository(locator<VpHomeService>()),
    );
    locator.registerLazySingleton(
      () => LpCreateRepository(
    ...
    locator.registerLazySingleton(
      () => EnDhanKycCubit(locator<EnDhanRepository>()),
    );
    locator.registerLazySingleton(
      () => EnDhanCustomerCubit(locator<EnDhanRepository>()),
    );
    locator.registerLazySingleton(
      () => EnDhanCardsCubit(locator<EnDhanRepository>()),
    );
