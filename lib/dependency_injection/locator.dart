...
void initLocator() {
  try {
    ...
    locator.registerFactory(() => KavachCheckoutShippingAddressBloc(locator<KavachRepository>()));
    locator.registerFactory(() => KavachCheckoutBillingAddressBloc(locator<KavachRepository>()));
    locator.registerFactory(() => KavachCheckoutVehicleBloc(locator<KavachRepository>()));
    locator.registerFactory(() => KavachCheckoutAddAddressBloc(locator<KavachRepository>()));
