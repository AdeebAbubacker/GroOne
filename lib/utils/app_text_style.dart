...
class AppTextStyle {
 ...
 static TextStyle primaryColor14w700 = primaryColor16w400.copyWith(
  ...
  static TextStyle body4PrimaryColor = body4.copyWith(color: AppColors.primaryColor);
  ...
  static TextStyle radialProgressText = GoogleFonts.poppins(fontWeight: FontWeight.w500,fontSize: 12,color: AppColors.primaryTextColor);
